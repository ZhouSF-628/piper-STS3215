...
- 项目结构与 [LeRobot](https://github.com/huggingface/lerobot) 一致，`from lerobot.motors import ...` 解析本地代码
- 详细指南见 `src/lerobot/robots/piper_follower/README.md`
...
# 4. 一次性初始化校准（首次使用）
python src/lerobot/robots/piper_follower/scripts/teleop.py \
